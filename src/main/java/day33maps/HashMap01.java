...
public class HashMap01 {
   ...
   //Basta HashMap olarak olusturduk, sonra TreeMap'e cevirdik, alfabetik siaraya gore versin diye
    ...
    //Example 1: Verilen bir String te hangi harfin kaç defa kullanıldığını veren metot oluşturunuz.
    //"Hello Henry!"==> H=2, e=2, l=2, o=1, n=1, r=1, y=1//Burada bir String bir Integer var
