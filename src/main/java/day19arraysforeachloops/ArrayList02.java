...
public class ArrayList02 {
     ...
     */
        ...
        //Iki ArrayList'in birbirine esit olup olmadigini nasil anlariz?#
        //equals() methodu ayni elemanlar ayni index'te oldugu surece yani yuzde yuz elemanlar ayni ve ayni
        //yerde ise true verir, aksi halse false verir.
        ...
        System.out.println(r3);//4 (4.index, sondaki K'yi gordu)
        ...
        for (Double w : prices) {
            if (prices.indexOf(w) == prices.lastIndexOf(w)) {
                System.out.print(w + " ");//3.75 4.0 (Bunlar tekrarsiz olanlar)
            }
        }
